...
urlpatterns = [
    ...
    path('category-delete/<int:pk>/',
         views.delete_category, name='category-delete'),
    ...
    path('item-image-management/', views.ItemImageManagementListView.as_view(),
         name='item-image-management'),
    path('item-image-add/', views.AddItemImageFormView.as_view(),
         name='item-image-add'),
    path('item-image-delete/<int:pk>/',
         views.delete_image, name='item-image-delete'),
]
